...
@Composable
fun DhEncryptDecryptSwitcherButtons(btnSelected: String = "encrypt") {
    ...
    Row {
        Button(
            ...
            onClick = {
                SoboRouter.navigateToRouteHandle(SCC_ROUTE_HANDLE.ENCRYPT_DH.value)
        ...
        Button(
            ...
            onClick = {
                SoboRouter.navigateToRouteHandle(SCC_ROUTE_HANDLE.DECRYPT_DH.value)
            }) {
            Text(
                modifier = Modifier,
                style = if (btnSelected == "encrypt") textStyleSelected else textStyleNotSelected,
